...
public final class CultivationRecipeBuilder implements RecipeBuilder {
    ...
    private CultivationRecipeBuilder(CultivationBookCategory cultivationBookCategory, Ingredient ingredient, ItemStack result, int time, float experience) {
    ...
    public static CultivationRecipeBuilder recipe(CultivationBookCategory cultivationBookCategory, Ingredient ingredient, ItemStack result, int time, float experience) {
    ...
    public void save(RecipeOutput recipeOutput, ResourceKey<Recipe<?>> recipeId) {
        ...
        recipeOutput.accept(recipeId, new CultivationRecipe(Objects.requireNonNullElse(this.group, ""), this.cultivationBookCategory, this.ingredient, this.result, this.time, this.experience), builder.build(recipeId.identifier().withPrefix("recipes/misc/")));
    }
