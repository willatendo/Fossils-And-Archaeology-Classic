...
public final class FCRecipeProvider extends RecipeProvider {
    private FCRecipeProvider(HolderLookup.Provider registries, RecipeOutput recipeOutput) {
    ...
    protected void buildRecipes() {
        ...
        this.cultivation(CultivationBookCategory.EGG, FCItems.TRICERATOPS_DNA.get(), new ItemStack(FCItems.TRICERATOPS_EGG.get()), 6000, 0.35F);
        ...
        this.cultivation(CultivationBookCategory.EGG, FCItems.DILOPHOSAURUS_DNA.get(), new ItemStack(FCItems.DILOPHOSAURUS_EGG.get()), 6000, 0.35F);
        this.cultivation(CultivationBookCategory.EGG, FCItems.BRACHIOSAURUS_DNA.get(), new ItemStack(FCItems.BRACHIOSAURUS_EGG.get()), 6000, 0.35F);

        this.cultivation(CultivationBookCategory.EMBRYO, FCItems.SMILODON_DNA.get(), new ItemStack(FCItems.SMILODON_EMBRYO_SYRINGE.get()), 6000, 0.35F);
        this.cultivation(CultivationBookCategory.EMBRYO, FCItems.MAMMOTH_DNA.get(), new ItemStack(FCItems.MAMMOTH_EMBRYO_SYRINGE.get()), 6000, 0.35F);
    ...
    private void cookFood(Item inputItem, Item outputItem) {
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(inputItem), RecipeCategory.FOOD, outputItem, 0.35F, 200).unlockedBy(RecipeProvider.getHasName(inputItem), this.has(inputItem)).save(this.output, FCCoreUtils.ID + ":" + outputItemName + "_from_smelting");
    ...
    private void analyzation(AnalyzationBookCategory analyzationBookCategory, ItemLike inputItemLike, TagKey<AnalyzationResult> analyzationResultsTagKey, int cookingTime, float experience) {
        ...
        AnalyzationRecipeBuilder.recipe(analyzationBookCategory, Ingredient.of(inputItemLike), analyzationResultsTagKey, cookingTime, experience).unlockedBy(RecipeProvider.getHasName(inputItemLike), this.has(inputItemLike)).save(this.output, FCCoreUtils.ID + ":" + inputName + "_outputs");
    }
    ...
    private void analyzation(AnalyzationBookCategory analyzationBookCategory, ItemLike inputItemLike, ItemLike outputItemLike, int cookingTime, float experience, Consumer<AnalyzationRecipeBuilder> consumer) {
        ...
        AnalyzationRecipeBuilder analyzationRecipeBuilder = AnalyzationRecipeBuilder.recipe(analyzationBookCategory, Ingredient.of(inputItemLike), new ItemStack(outputItemLike), cookingTime, experience).unlockedBy(RecipeProvider.getHasName(inputItemLike), this.has(inputItemLike));
        consumer.accept(analyzationRecipeBuilder);
        analyzationRecipeBuilder.save(this.output, FCCoreUtils.ID + ":" + outputName + "_from_" + inputName);
    }

    private void cultivation(CultivationBookCategory cultivationBookCategory, ItemLike inputItemLike, ItemStack outputItemStack, int cookingTime, float experience) {
        this.cultivation(cultivationBookCategory, inputItemLike, outputItemStack, cookingTime, experience, cultivationRecipeBuilder -> {
        });
    }

    private void cultivation(CultivationBookCategory cultivationBookCategory, ItemLike inputItemLike, ItemStack outputItemStack, int cookingTime, float experience, Consumer<CultivationRecipeBuilder> consumer) {
        String outputName = BuiltInRegistries.ITEM.getKey(outputItemStack.getItem()).getPath();
    ...
    private void restoration(RestorationBookCategory restorationBookCategory, ItemLike inputItemLike, ItemLike outputItemLike, int cookingTime, float experience, Consumer<RestorationRecipeBuilder> consumer) {
        String outputName = BuiltInRegistries.ITEM.getKey(outputItemLike.asItem()).getPath();
        RestorationRecipeBuilder restorationRecipeBuilder = RestorationRecipeBuilder.recipe(restorationBookCategory, Ingredient.of(inputItemLike), new ItemStack(outputItemLike), cookingTime, experience).unlockedBy(RecipeProvider.getHasName(inputItemLike), this.has(inputItemLike));
    ...
    public static final class Runner extends RecipeProvider.Runner {
        ...
        protected RecipeProvider createRecipeProvider(HolderLookup.Provider registries, RecipeOutput recipeOutput) {
            return new FCRecipeProvider(registries, recipeOutput);
        }
