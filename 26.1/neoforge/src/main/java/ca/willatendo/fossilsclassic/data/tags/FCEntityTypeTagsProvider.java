...
public final class FCEntityTypeTagsProvider extends EntityTypeTagsProvider {
    public FCEntityTypeTagsProvider(PackOutput packOutput, CompletableFuture<HolderLookup.Provider> registries, String modId) {
