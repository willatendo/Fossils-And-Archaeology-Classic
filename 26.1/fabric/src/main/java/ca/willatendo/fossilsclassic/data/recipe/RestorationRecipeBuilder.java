...
public final class RestorationRecipeBuilder implements RecipeBuilder {
    ...
    private RestorationRecipeBuilder(RestorationBookCategory restorationBookCategory, Ingredient ingredient, ItemStackTemplate result, int time, float experience) {
    ...
    public static RestorationRecipeBuilder recipe(RestorationBookCategory restorationBookCategory, Ingredient ingredient, ItemStackTemplate result, int time, float experience) {
    ...
    public void save(RecipeOutput recipeOutput, ResourceKey<Recipe<?>> recipeId) {
        ...
        recipeOutput.accept(recipeId, new RestorationRecipe(RecipeBuilder.createCraftingCommonInfo(true), new RestorationRecipe.RestorationBookInfo(this.restorationBookCategory, Objects.requireNonNullElse(this.group, "")), this.ingredient, this.result, this.time, this.experience), builder.build(recipeId.identifier().withPrefix("recipes/misc/")));
    }
