...
public final class FossilsClassicMod {
    public static void modInit(ModInit modInit) {
        ...
        modInit.register(FCAttributes.ATTRIBUTES, FCJsonBehaviorTypes.JSON_BEHAVIOR_TYPES, FCGeneTypes.GENE_TYPES, FCStructureProcessorTypes.STRUCTURE_PROCESSOR_TYPES, FCStructurePoolElementTypes.STRUCTURE_POOL_ELEMENT_TYPES, FCStats.CUSTOM_STATS, FCSoundEvents.SOUND_EVENTS, FCDataComponents.DATA_COMPONENT_TYPES, FCRecipeBookCategories.RECIPE_BOOK_CATEGORIES, FCSlotDisplays.SLOT_DISPLAY_TYPES, FCRecipeDisplays.RECIPE_DISPLAY_TYPES, FCRecipeTypes.RECIPE_TYPE, FCRecipeSerializers.RECIPE_SERIALIZERS, FCCommandTypes.COMMAND_TYPES, FCGameRules.GAME_RULES, FCLootPoolEntries.LOOT_POOL_ENTRY_TYPES, FCMenuTypes.MENU_TYPES, FCBlockTypes.BLOCK_TYPES, FCBlocks.BLOCKS, FCBlockEntityTypes.BLOCK_ENTITY_TYPES, FCEntityTypes.ENTITY_TYPES, FCItems.ITEMS, FCCreativeModeTabs.CREATIVE_MODE_TABS);
