...
public class CultivatorResultSlot extends Slot {
    ...
    public CultivatorResultSlot(Player player, Container container, int slot, int xPosition, int yPosition) {
    ...
    protected void checkTakeAchievements(ItemStack itemStack) {
        ...
        if (this.player instanceof ServerPlayer serverPlayer) {
            if (this.container instanceof CultivatorBlockEntity cultivatorBlockEntity) {
                cultivatorBlockEntity.awardUsedRecipesAndPopExperience(serverPlayer);
            }
        }
