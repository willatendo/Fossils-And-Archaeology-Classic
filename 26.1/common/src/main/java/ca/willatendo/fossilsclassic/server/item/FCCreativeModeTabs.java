...
public final class FCCreativeModeTabs {
    ...
    public static final SimpleHolder<CreativeModeTab> FOSSILS_CLASSIC = CREATIVE_MODE_TABS.register("fossils_classic", () -> new ItemStack(FCItems.FOSSIL.get()), (itemDisplayParameters, output) -> {
    ...
    public static final SimpleHolder<CreativeModeTab> FOSSILS_CLASSIC_SPAWN_EGGS = CREATIVE_MODE_TABS.register("fossils_classic_spawn_eggs", () -> new ItemStack(FCItems.FAILURESAURUS_SPAWN_EGG.get()), (itemDisplayParameters, output) -> {
