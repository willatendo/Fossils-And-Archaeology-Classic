...
public enum AnalyzationBookCategory implements StringRepresentable {
    ...
    ARCHAEOLOGY(2, "archaeology"),
    MISC(3, "misc");

    private static final IntFunction<AnalyzationBookCategory> BY_ID = ByIdMap.continuous(analyzationBookCategory -> analyzationBookCategory.id, AnalyzationBookCategory.values(), ByIdMap.OutOfBoundsStrategy.ZERO);
